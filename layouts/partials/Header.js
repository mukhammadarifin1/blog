...
import { IoSearch, IoMoon, IoPartlySunny } from "react-icons/io5";
...
const Header = () => {
  ...
  const renderThemeChanger = () => {
    ...
    if (currentTheme === "dark") {
      return (
        <IoPartlySunny
          className="h-10 w-6 text-yellow-500 "
          role="button"
      ...
      return (
        <IoMoon
          className="h-10 w-6 text-gray-900 "
          role="button"
  ...
  return (
    <>
      <header
        className={`sticky top-0 py-2 transition-all ${
          navFixed ? "z-50 dark:bg-theme-dark" : "pt-2"
        }`}
      >
